...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(0,0){\includegraphics[scale=1]{portada_con_logo.png}}} % Image background
\centering
\vspace*{5cm}
...
\vspace*{0.3cm}
{\Huge \textbf{MAGÍSTER EN INGENIERÍA DE\\ REDES DE COMUNICACIONES}}\par % Author name
\endgroup
...
\noindent \textsc{www.mirc.uchile.cl}\\ % URL
...
\input{plan_fcfm_2030.tex}

\section{Cursos Electivos}\label{electivos}
\input{cursos_electivos.tex}
